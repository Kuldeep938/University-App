...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarTextView.setText("Academic Calendar ");
    ...
    private void retrieveCalendar(){
        if (userId != null) {
            CollectionReference profileRef = firestore.collection("calendar");
            ...
            profileRef.get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(CalendarActivity.this, "Failed to retrieve event details  ", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
