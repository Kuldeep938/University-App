            ...
            profileRef.get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        String courseName = document.getString("course");
                        String facultyName = document.getString("faculty");
                        String percentage = document.getString("percentage");

                        if (courseName != null && facultyName != null && percentage != null) {
                            String userDetails = "\n\nCourse: " + courseName +
                                    "\n\n\nFaculty: " + facultyName +
                    ...
                    Toast.makeText(AttendanceActivity.this, "Failed to retrieve details  ", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
